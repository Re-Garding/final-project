...
class DailyWords(db.Model):
    ...
    dict_key_id = db.Column(db.Integer, db.ForeignKey("dictionary_words.dict_key_id"))
    datetime = db.Column(db.DateTime)
    finished_true_false = db.Column(db.Boolean, default = False) 
...
class DictionaryWords(db.Model):
    ...
    dict_key_id = db.Column(db.Integer,
                        autoincrement=True,
                        primary_key=True)
    definition = db.Column(db.String)
    age_input = db.Column(db.Integer)

    word_of_day = db.relationship("DailyWords", back_populates="dictionary_words") #word of the day
...
class DailyQuiz(db.Model):
    ...
    quiz_of_day_id = db.Column(db.Integer,
                        autoincrement=True,
                        primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey("users.user_id"))
    datetime = db.Column(db.DateTime)
...
def connect_to_db(flask_app, db_uri="postgresql:///apptest", echo=True):  
